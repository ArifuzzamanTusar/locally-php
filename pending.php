...
<html lang="en">
  ...
  <h4 class="text-warning">Your account is under review.</h4>
  <h6>Your account will be approved soon!</h6>
  
  <div class="p-4">
  
  <a name="" id="" class="btn btn-primary" href="index.php" role="button">BACK TO HOME</a>
  <a name="" id="" class="btn btn-warning" href="logout.php?logout" role="button">Log Out</a>
  </div>
  </center>
  </div>
  </div>
