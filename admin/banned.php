...
<div class="container-fluid">
    ...
    <div class="users">
        ...
        <?php
         $topic_query = " SELECT * FROM `user` WHERE `status` LIKE 'banned' ORDER BY id DESC";
        ...
        ?>
            ...
            <div class="row table_row p-2">
                ...
                <div class="col-sm-3 col-md-3">
                    ...
                    <td class="c1 t-row"><a class="btn btn-danger" href="pending-process.php?id=<?php echo $user_id?>">Pending</a></td>
