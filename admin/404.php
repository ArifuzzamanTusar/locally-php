...
<body>
    ...
    <div class="error">
        <div class="error__title">Oh No!</div>
        <div class="error__subtitle">Database connection lost.....</div>
        <div class="error__description">It looks like MySql Connection Error <br> Please check the Connection Credentials</div>
